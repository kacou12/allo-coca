            ...
            <TableHeader class=" bg-neutral-90">
                <TableRow v-for="headerGroup in table.getHeaderGroups()" :key="headerGroup.id">
                    <TableHead v-for="header in headerGroup.headers"
                        :width="dynamicWidthColumns ? undefined : header.column.columnDef.size" :key="header.id">
                    ...
                    <template v-else>
                        <TableRow>
                            <TableCell :colspan="columns.length" class="h-[calc(95vh/2)] text-center">
                                <img src="@/assets/images/empty_table.gif" alt=""
                                    class="max-w-[150px] max-h-[150px] mx-auto">
                            </TableCell>
                        </TableRow>
                    </template>
                </TableBody>
