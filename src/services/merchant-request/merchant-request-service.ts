...
} from './merchant-request-schema'
import type { MerchantDepositRequest, MerchantRequestResponse, MerchantWithdrawalRequest } from './merchant-request.type'
...
export async function depositRequest(data: MerchantDepositRequest): Promise<any | undefined> {
  try {
...
export async function withdrawalRequest(data: MerchantWithdrawalRequest): Promise<any | undefined> {
  try {
