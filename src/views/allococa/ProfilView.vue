<template>
    <div class="px-4  pt-[110px]   maxContain3xl mx-auto">
...
const userState = reactive<AuthResponse>({

    name: authUser.user.value!.name,  // email de l'utilisateur
    email: authUser.user.value!.email,
    phone: authUser.user.value!.phone,
    address: authUser.user.value!.address,
    role: authUser.user.value!.role,
